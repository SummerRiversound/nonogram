<template>
  <v-container class="pa-1" fluid>
    ...
    <v-row align="center" align-content="center">
      <v-col class="text-center bg-logo"> </v-col>
    </v-row>
        ...
        <v-col>
          <v-list>
            <div
              ...
              :key="`achidevement-${index}`"
            >
              <v-divider></v-divider>
              <v-list-item style="height: 66px">
                <span>
                  <v-img
                    v-if="achievementsStatus[index]"
                    height="60"
                    width="60"
                    contain
                    src="@/assets/achievements/img/2.png"
                  ></v-img>
                  <v-img
                    v-else
                    height="60"
                    width="60"
                    contain
                    src="@/assets/achievements/img/1.png"
                  ></v-img>
                </span>
                {{ achieve.name.kr }}
              </v-list-item>
